    ...
    <div class="row">
        <div class="col-6 px-5">
            ...
            <form>
                <div class="form-group border-0 mb-3">
                    <input type="email" class="form-control border-0 rounded-0" id="contactEmail" aria-describedby="emailHelp" placeholder="Enter email">
                </div>
                <div class="form-group border-0 mb-3">
                    <input type="email" class="form-control border-0 rounded-0" id="contactSubject" aria-describedby="emailHelp" placeholder="Subject">
                </div>
                <textarea id="contactMessage" name="description" class="w-100 h-input-text p-2" rows="4" placeholder="Message..."></textarea>
                <div id="contactFeedback" class="invalid-feedback d-none"></div>
        ...
        <div class="col-6">
            ...
            <div id="contactSocials" class="d-flex justify-content-center align-items-center mb-4">
                ...
                <a href="https://twitter.com" target="_blank"><img src="fonts/icons/twitter.svg" alt="Social icon"></a>
